...
## Getting Started
Make sure that you have Node.js (v0.11 and above) and MongoDB (running on the default port 27017) installed on your computer. To get started with KOAN stack, clone or [download](https://github.com/soygul/koan/archive/master.zip) the project repository and do following:
