...
## Getting Started
Make sure that you have Node.js v0.12 or higher and MongoDB v2.x (running on the default port 27017) installed on your computer. To get started with KOAN stack, do following:
